                    ...
                    <div class="d-date-time-contain" @click.stop v-if="isShow">
                        ...
                        <div class="d-date-time-content" :class="{dayTop: type === 'day'}">
                            ...
                            <div class="d-date-time-time-wrap" v-if="status === 'time'">
                                <i v-if="(type !=='time' && type !=='tkTime') || showTimeBack" class="d-data-time-close iconfont icon-close"
                                   @click="close"></i>
                        ...
                        <div class="d-date-time-button" v-if="type !== 'tkTime'" >
                             <a @click="now" :style="{color: color}" v-show="showToday && showTodayButton">现在</a>
                            <a @click="hide" :style="{color: color}">选择日期</a>
                            <a @click="confirm" :style="{color: color}">确认</a>
                        </div>
                        <div class="d-date-time-button" v-else >
                            <a @click="tkSelectDate" v-if="status === 'time'" :style="{color: color}">选择日期</a>
                            <a @click="tkSelectTime" v-else :style="{color: color}">选择时间</a>
                            <a @click="confirm" :style="{color: color}">确认</a>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
             ...
             */
            selectYear() {
                if (this.type === 'year' || this.type === 'dateTime' || this.type === 'date' || this.type === 'tkTime') {
                    this.status = 'year';
             ...
             */
            selectMonth() {
                if (this.type === 'month' || this.type === 'dateTime' || this.type === 'date' || this.type === 'noMinute' || this.type === 'tkTime') {
             ...
             */
            close() {
                if (this.type === 'dateTime' || this.type === 'noMinute' || this.type === 'date' || this.type === 'tkTime') {
                    this.status = 'day';
